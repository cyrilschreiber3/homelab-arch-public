...
| bind9           | Dns server serving as upstream for all local dns entries. (Static zone files + rfc2136 configuration) | dns://10.1.1.142 (all)<br>dns://10.1.1.143 (master only) |
